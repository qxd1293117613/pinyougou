...
<#--获取扩展表属性-->
<#assign custAttributeList=goodsDesc.customAttributeItems?eval/>
<#assign specitionList=goodsDesc.specificationItems?eval/>
		...
		<div id="item">
			...
			<div class="product-info">
				<div class="fl preview-wrap">
					<!--放大镜效果-->
					<div class="zoom">
						<!--默认第一个预览,默认第一个也就是取出集合第一个对象的地址url-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								<dt>
									<div class="fl title">
										<#list spec.attributeValue as one>
                                            <i>${one??}</i>
										</#list>
								</div>
								</dt>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									...
									<#list custAttributeList as item>
										<#if item.value??>
